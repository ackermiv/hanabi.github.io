...
Similar to a Trash Finesse, a reverse trash finesse will also Chop Move all of the cards to the right of the trash card (similar to how a Trash Chop Move works).
